...
if (Auth::check() && Auth::user()->role_id == '2') {
    ...
    elseif (Auth::check() && Auth::user()->role_id == '5') {
         return redirect('exams/student/categories');
        // return view('exams/student/categoriese');
...
Route::get('admitcard/{slug}', 'AdmitcardController@getAdmitcard');
...
Route::get('admin/quizresults', 'StudentQuizController@userQuizResults');
