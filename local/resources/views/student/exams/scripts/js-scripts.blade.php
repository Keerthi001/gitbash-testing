...
// $('.question_div:first-child').addClass('show_question');
// onlclick of next button

var quest_count = $('.question_div').length;
$('.finish').hide();
var countclick=1
$('.next').click(function() {
  countclick++;
  if(countclick<=quest_count)
  {
  $("#question_number").html(+countclick);
}
if(countclick==quest_count)
{
    $('.next').hide();
...
// $('.question_div:first-child').removeClass('show_question');
  ...
  // $('.question_div:first-child').addClass(show_question);
// $('.question_div:visible').prev().hide();
   $('.question_div:visible').last().next('.question_div:hidden').show();
   $('.question_div:first-child').attr('id','hello');
   // $('.question_div:first-child').hide();
