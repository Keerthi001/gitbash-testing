...
@if(checkRole(getUserGrade(2))) 
<div class="pull-right messages-buttons"><a href="{{URL_USERS}}" class="btn btn-primary" >{{ getPhrase('list')}}</a></div>
@endif
...
{{ Form::model($record, 
        ...
        <fieldset class="form-group ">
            ...
            <div class="col-md-12 clearfix"></div>
                                ...
                                <button type="submit" class="btn btn-success">{{getphrase('update')}}</button>
                                      </div>
                                {!! Form::close() !!}
                                @else
