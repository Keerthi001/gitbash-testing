	      	...
	      	<div class="x_panel">
					...
					@if(checkRole(getUserGrade(2)))
						<div class="pull-right messages-buttons">
							...
							<a href="{{URL_USERS}}" class="btn  btn-success button" >{{ getPhrase('list')}}</a>
 				...
 				<?php
					...
					<div class="col-md-3">
						<label class="checkbox-inline">
							<input type="checkbox" data-toggle="toggle" name="quiz_categories[{{$category->id}}]" data-onstyle="success" data-offstyle="success" {{$checked}}> {{$category->category}}
						</label>
					</div>
					@endforeach
