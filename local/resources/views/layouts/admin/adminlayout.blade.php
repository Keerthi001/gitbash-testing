			...
			<ul class="nav navbar-right top-nav">
				...
				<li class="dropdown profile-menu">
					<div class="dropdown-toggle top-profile-menu" data-toggle="dropdown">
						...
						<div class="profile-img"> <img src="{{ getProfilePath(Auth::user()->image, 'thumb') }}" alt="">
						</div>
		...
		<aside class="left-sidebar">
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
					...
					<li {{ isActive($active_class, 'users') }}> <a href="{{URL_USERS}}"> <i class="fa fa-user aria-hidden="true"></i> {{ getPhrase('users')}}</a> </li>
			...
			<a data-toggle="collapse" data-target="#exams"><i class="fa fa-question aria-hidden="true" ></i> {{getPhrase('exams')}}</a>
					...
					<li {{ isActive($active_class, 'notifications') }} >
						<a href="{{URL_ADMIN_NOTIFICATIONS}}" ><i class="fa fa-bell-o" aria-hidden="true"></i> {{ getPhrase('notifications') }} </a>
					...
					<li {{ isActive($active_class, 'result') }} >
						<a href="{{URL_ADMIN_NOTIFICATIONS}}" ><i class="fa fa-list" ></i>
					{{ getPhrase('result') }} </a>
