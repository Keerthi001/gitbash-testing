...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 06, 2018 at 12:44 PM
...
INSERT INTO `users` (`id`, `name`, `username`, `email`, `password`, `slug`, `login_enabled`, `role_id`, `parent_id`, `image`, `phone`, `address`, `stripe_active`, `stripe_id`, `stripe_plan`, `paypal_email`, `card_brand`, `card_last_four`, `trial_ends_at`, `subscription_ends_at`, `remember_token`, `settings`, `deleted_at`, `created_at`, `updated_at`) VALUES
(21754, 'vara', '1611006', 'vara.n@indivillage.com', '$2y$10$TRpTOUGw8VhFjefWuMFzoO8lx9p8ELSgTtOZMUS.3mmMWSNqJ2leO', 'vara', 2, 2, NULL, '', NULL, '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'f8sAZ71LFzKKsxQSOBcCW7p59cwBkOxE1d0kt6uiadYXn3rV3UfwjX90Rm1S', '{\"user_preferences\":{\"quiz_categories\":[],\"lms_categories\":[]}}', NULL, '2018-09-05 09:45:32', '2018-09-06 10:41:38');
